...
-- QUESTION 6: Which internet service type has the highest churn rate,  and how does it rank against the others when accounting for average monthly charges?
...
-- QUESTION 7: How does churn rate change from one tenure bucket to the next,  and at which transition does churn drop most sharply?
